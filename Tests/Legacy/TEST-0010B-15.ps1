...
Write-Host ""
Write-Host "========================================"
Write-Host " TEST-0010B-15"
Write-Host " PROCESS ID + ACK"
Write-Host "========================================"
Write-Host ""
...
# ============================================================
# SEND VIA TRANSPORT LIBRARY + PROCESS ID ACK
# ============================================================

Write-Host ""
Write-Host "[LIB] Send-EpsonPrintDataWithAck"
...
Write-Host "========================================"
Write-Host " TEST-0010B-15"
Write-Host " PROCESS ID / ACK RESULT"
Write-Host "========================================"
Write-Host ""
...
switch ($result.TransportStatus) {
    ...
    default {
        ...
        Write-Host "========================================"
        Write-Host " RESULT: UNEXPECTED STATUS"
        Write-Host "========================================"
    }
}
...
Write-Host ""
Write-Host "TEST-0010B-15 finished."
